<!-- This page is used to approve participants for a given event -->
				...
				<div class="right_combined_column">
					<div class="middle_column margin_left">
						<div class="page_title">
								<span class="page_label">APPROVE PARTICIPANTS</span><br><br>
						</div>
						<div class="save_view_details">
							<a href="./admin_index.php"><button type="button">SAVE</button></a>
							&nbsp; &nbsp;
												...
												if (mysql_num_rows($member_result) > 0 ){
													while($member_row = mysql_fetch_assoc($member_result)){
														...
														echo '<tr>';
															...
															echo '<td>'.$gender. '</td>';
															echo '<td>'.$landline. '</td>';
															if (strtolower($registration_status) == "pending"){
																echo '<td><input type="checkbox" name="registration_status[]"></td>';
															}
															else{
